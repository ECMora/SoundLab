...
class BatSoundWindow(QtGui.QMainWindow, Ui_DuettoMainWindow):
    ...
    def on_actionResampling_triggered(self):
        ...
        if resamplingDialogWindow.exec_():
            ...
            if MIN_SAMPLING_RATE < val < MAX_SAMPLING_RATE:
    ...
    def on_actionSave_triggered(self):
        fname = unicode(QFileDialog.getSaveFileName(self,"Save the signal as wav",self.widget.signalProcessor.signal.name()+".wav","*.wav"))
        if fname:
