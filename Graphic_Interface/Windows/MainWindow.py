...
#
# Created: Fri Apr 18 10:43:31 2014
...
"border-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0.136364 rgba(0, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));"))
        ...
        self.menuFile.setGeometry(QtCore.QRect(91, 143, 143, 235))
        ...
        self.actionDeselect = QtGui.QAction(DuettoMainWindow)
    ...
    def retranslateUi(self, DuettoMainWindow):
        ...
        self.menuPlay_Speed.setTitle(_translate("DuettoMainWindow", "Play Speed", None))
        self.dock_settings.setWindowTitle(_translate("DuettoMainWindow", "Settings", None))
        ...
        self.actionExit.setShortcut(_translate("DuettoMainWindow", "Alt+X", None))
        ...
        self.actionPlay_Sound.setShortcut(_translate("DuettoMainWindow", "Ctrl+P", None))
        ...
        self.actionSettings.setShortcut(_translate("DuettoMainWindow", "Ctrl+Shift+S", None))
        ...
        self.actionUndo.setText(_translate("DuettoMainWindow", "Undo", None))
        self.actionUndo.setShortcut(_translate("DuettoMainWindow", "Ctrl+Z", None))
        self.actionRedo.setText(_translate("DuettoMainWindow", "Redo", None))
        self.actionRedo.setShortcut(_translate("DuettoMainWindow", "Ctrl+Y", None))
        self.action1x.setText(_translate("DuettoMainWindow", "1x", None))
        self.action2x.setText(_translate("DuettoMainWindow", "2x", None))
        self.action4x.setText(_translate("DuettoMainWindow", "4x", None))
        self.action8x.setText(_translate("DuettoMainWindow", "8x", None))
        self.action1_2x.setText(_translate("DuettoMainWindow", "1/2x", None))
        self.action1_4x.setText(_translate("DuettoMainWindow", "1/4x", None))
        self.action1_8x.setText(_translate("DuettoMainWindow", "1/8x", None))
        self.actionZoom_Cursor.setText(_translate("DuettoMainWindow", "Zoom Cursor", None))
        self.actionPointer_Cursor.setText(_translate("DuettoMainWindow", "Pointer Cursor", None))
        self.actionFull_Screen.setText(_translate("DuettoMainWindow", "Full Screen", None))
        self.actionFile_Up.setText(_translate("DuettoMainWindow", "File Up", None))
        self.actionFile_Up.setShortcut(_translate("DuettoMainWindow", "Ctrl+Up", None))
        self.actionFile_Down.setText(_translate("DuettoMainWindow", "File Down", None))
        self.actionFile_Down.setShortcut(_translate("DuettoMainWindow", "Ctrl+Down", None))
        ...
        self.actionRectangular_Cursor.setText(_translate("DuettoMainWindow", "Rectangular Cursor", None))
        self.actionRectangular_Eraser.setText(_translate("DuettoMainWindow", "Rectangular Eraser", None))
