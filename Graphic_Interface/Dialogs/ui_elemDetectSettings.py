...
#
# Created: Wed Mar 19 14:47:01 2014
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.widgetOscilogram = QSignalVisualizerWidget(self.dockWidgetContents_2)
        self.widgetOscilogram.setObjectName(_fromUtf8("widgetOscilogram"))
        self.verticalLayout.addWidget(self.widgetOscilogram)
        self.dockWidget.setWidget(self.dockWidgetContents_2)
        self.verticalLayout_2.addWidget(self.dockWidget)
        self.dockWidget_2 = QtGui.QDockWidget(Dialog)
        self.dockWidget_2.setObjectName(_fromUtf8("dockWidget_2"))
        self.dockWidgetContents_3 = QtGui.QWidget()
        self.dockWidgetContents_3.setObjectName(_fromUtf8("dockWidgetContents_3"))
        self.gridLayout_3 = QtGui.QGridLayout(self.dockWidgetContents_3)
        self.gridLayout_3.setObjectName(_fromUtf8("gridLayout_3"))
        self.widgetSpecgram = QSignalVisualizerWidget(self.dockWidgetContents_3)
        self.widgetSpecgram.setObjectName(_fromUtf8("widgetSpecgram"))
        self.gridLayout_3.addWidget(self.widgetSpecgram, 4, 1, 1, 1)
