...
#
# Created: Sat Jul 19 18:56:52 2014
...
class Ui_EditCategoryWidget(object):
    def setupUi(self, EditCategoryWidget):
        ...
        EditCategoryWidget.resize(296, 91)
        ...
        self.gridLayout.addWidget(self.comboCategories, 1, 0, 1, 2)
        ...
        self.bttnAddValue.setIcon(icon)
        self.bttnAddValue.setObjectName(_fromUtf8("bttnAddValue"))
        self.gridLayout.addWidget(self.bttnAddValue, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEditCategoryValue, 3, 1, 1, 2)
        ...
        self.bttnRemoveSelected.setIcon(icon1)
        self.bttnRemoveSelected.setObjectName(_fromUtf8("bttnRemoveSelected"))
        self.gridLayout.addWidget(self.bttnRemoveSelected, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelCategoryName, 0, 0, 1, 2)
