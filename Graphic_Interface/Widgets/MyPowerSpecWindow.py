...
class PowerSpectrumWindow(QtGui.QMainWindow):
    def __init__(self,parent=None,plotColor="FFF",backColor="FFF",gridx=True,gridy=True,maxY=10,minY=-60):
    ...
    def plot(self, data, rate, NFFT, window,overlap):
        ...
        self.ui.pow_spec.Plot_Power_Spectrum(data, self.rate, self.NFFT, self.window,self.overlap,self.plotColor, self.backColor, self.gridx, self.gridy,self.minY,self.maxY)
