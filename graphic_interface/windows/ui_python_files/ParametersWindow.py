...
#
# Created: Wed May 13 12:10:23 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.save_bttn, 1, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.parameter_locations_table, 0, 0, 1, 1)
        self.tab_parameters.addTab(self.tab_spectral_params, _fromUtf8(""))
        self.gridLayout.addWidget(self.tab_parameters, 0, 0, 1, 2)
