...
#
# Created: Fri Feb 13 14:18:33 2015
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.dock_parameter_measurement.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.dock_parameter_measurement.setStyleSheet(_fromUtf8(""))
        self.dock_parameter_measurement.setFloating(False)
        self.dock_parameter_measurement.setFeatures(QtGui.QDockWidget.AllDockWidgetFeatures)
        ...
        self.gridLayout.addWidget(self.dock_parameter_measurement, 0, 1, 2, 2)
        ...
        self.dock_segm_classif.setMinimumSize(QtCore.QSize(250, 84))
        ...
        self.dock_segm_classif.setFeatures(QtGui.QDockWidget.AllDockWidgetFeatures)
