...
#
# Created: Tue Feb 10 09:32:34 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.pushButtonStart, 3, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.pushButtonInputFolder, 0, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.pushButtonOutputFolder, 1, 1, 1, 2)
        ...
        self.rbttnSplitFile.setChecked(True)
        self.rbttnSplitFile.setObjectName(_fromUtf8("rbttnSplitFile"))
        self.formLayout.setWidget(1, QtGui.QFormLayout.LabelRole, self.rbttnSplitFile)
        ...
        self.formLayout.setWidget(2, QtGui.QFormLayout.SpanningRole, self.spboxSplitTime)
