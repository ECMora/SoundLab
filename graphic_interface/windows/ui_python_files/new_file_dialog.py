...
# Form implementation generated from reading ui file 'E:\Biologia\DUETTO PROGRAMS\Desktop\Sound Lab\duetto-SoundLab\graphic_interface\UI_Files\new_file_dialog.ui'
#
# Created: Mon Dec 07 14:11:50 2015
...
class Ui_NewFileDialog(object):
    def setupUi(self, NewFileDialog):
        ...
        self.formLayout.setWidget(3, QtGui.QFormLayout.LabelRole, self.rbtnSilence)
        ...
        self.formLayout.setWidget(3, QtGui.QFormLayout.FieldRole, self.rbtnWhiteNoise)
    ...
    def retranslateUi(self, NewFileDialog):
        ...
        self.cbxBitDepth.setItemText(1, QtGui.QApplication.translate("NewFileDialog", "16", None, QtGui.QApplication.UnicodeUTF8))
