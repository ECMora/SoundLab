# -*- coding: utf-8 -*-
from sound_lab_core.ParametersMeasurement.WaveletParameters import WaveletDeltaParameter
...
class WaveletDeltaParameterAdapter(WaveletParameterAdapter):
    ...
    def get_instance(self):
        ...
        return WaveletDeltaParameter(level=self.level, wavelet=self.wavelet)
