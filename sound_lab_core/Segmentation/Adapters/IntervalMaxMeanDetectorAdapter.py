...
from sound_lab_core.Segmentation.OneDimensional.EnvelopeMethods import IntervalMaxMeanEnvelope
...
class IntervalMaxMeanDetectorAdapter(IntervalDetectorAdapter):
    ...
    def get_instance(self, signal):
        ...
        return IntervalMaxMeanEnvelope(signal, self.threshold_dB, self.threshold2_dB,
