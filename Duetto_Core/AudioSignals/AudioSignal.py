...
class AudioSignal:
    ...
    def __init__(self,playingdelegate=lambda x: x):
        ...
        #delegate for playing cursors ********************change this patch with signaks and slots
        self.playing = playingdelegate
    ...
    def playCallback(self, in_data, frame_count, time_info, status):
        ...
        self.playing(self.playSection[2])
