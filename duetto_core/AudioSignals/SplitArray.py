...
#print('started with ndarray')
#for i in range(44*120):
#    a2 = np.concatenate((a2, np.random.normal(size=1024)))
#    temp = a2[-120000:]
#print('ended with ndarray')
#end = datetime.datetime.now()
#print(end-start)
#
#start = datetime.datetime.now()
#print('started with SplitArray')
#for i in range(44*120):
#    a1.extend(np.random.normal(size=1024))
#    temp = a1[-120000:]
#a1.join()
#print('ended with SplitArray')
#end = datetime.datetime.now()
#print(end-start)
